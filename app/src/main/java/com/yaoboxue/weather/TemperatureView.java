...
import com.yaoboxue.weather.util.TemperUtil;
...
public class TemperatureView extends View {
    ...
    private int pointTopY = (int) (30 * TemperUtil.getDensity(getContext()));
    private int pointBottomY = (int) (100 * TemperUtil.getDensity(getContext()));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int mDefaultHeight = (int) (220 * TemperUtil.getDensity(getContext()));
    ...
    private void drawValue(Canvas canvas){
        ...
        canvas.drawText(currentValue+"°",pointX , pointY - 30, mPaint);
    }
    ...
    public void drawGraph(Canvas canvas){
        ...
        if(isDrawLeftLine){
            float middleValue = currentValue - (currentValue - lastValue) / 3f;
